...
window.pageYOffset)>a(g)-q&&(d.$apply(f),b.unobserveInstantly))return e.removeEventListener("scroll",k)},b.throttleWait);e.addEventListener("scroll",k);b.observeInstantly&&c(k)}}}]).directive("ngLazyLoad",["ngLazyLoad",function(e){return{restrict:"A",controller:["$element",function(c){this.scrollOffset=e.scrollOffset;this.aot=c.attr("aot")||!1;this.scrollHandler=function(e){c.attr("lazy-src")&&(c.attr("src",c.attr("lazy-src")),c.removeAttr("lazy-src"));c.attr("use-io")&&c.removeAttr("use-io")}}],
controllerAs:"ll",template:"\x3cimg on-scroll-to\x3d'll.scrollHandler' use-io\x3d'!ll.aot' /\x3e",replace:!0,priority:50}}])})();
